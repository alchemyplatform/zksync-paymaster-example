    ...
    return class Adapter extends Base {
        ...
        async getDepositTx(transaction) {
            ...
            if (tx.bridgeAddress) {
                ...
                const bridge = typechain_1.IL1Bridge__factory.connect(tx.bridgeAddress, this._signerL1());
            ...
            const zksyncContract = await this.getMainContract();
            const baseCost = await zksyncContract.l2TransactionBaseCost(gasPriceForEstimation, tx.l2GasLimit, tx.gasPerPubdataByte);
            if (token === utils_1.ETH_ADDRESS) {
                ...
                const refundRecipient = tx.refundRecipient ?? ethers_1.ethers.ZeroAddress;
                const args = [
                    to,
                    token,
                    amount,
                ...
                const bridge = l2WethToken !== ethers_1.ethers.ZeroAddress
        ...
        async getFullRequiredDepositFee(transaction) {
            ...
            if (tx.bridgeAddress) {
                ...
                const bridge = typechain_1.IL1Bridge__factory.connect(tx.bridgeAddress, this._signerL1());
                const l2Address = await bridge.l2Bridge();
                l2GasLimit = await (0, utils_1.estimateCustomBridgeDepositL2Gas)(this._providerL2(), tx.bridgeAddress, l2Address, tx.token, dummyAmount, tx.to, customBridgeData, await this.getAddress(), tx.gasPerPubdataByte);
            }
            else {
                l2GasLimit = await (0, utils_1.estimateDefaultBridgeDepositL2Gas)(this._providerL1(), this._providerL2(), tx.token, dummyAmount, tx.to, await this.getAddress(), tx.gasPerPubdataByte);
            }
